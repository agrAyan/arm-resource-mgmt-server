...
import com.acheron.resource.mngt.service.ITaskService;
import com.acheron.resource.mngt.vo.TaskVO;
...
public class TaskController {
	...
	@PutMapping("/tasks")
	public ResponseEntity<Task> assignResourceFromResourceView(@RequestBody Task task){
		HttpHeaders headers = new HttpHeaders();
		headers.add("desc", "Get Brandlist By Name");
		return ResponseEntity.ok().headers(headers).body(taskService.updateTask(task));
