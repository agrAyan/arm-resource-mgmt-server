...
public class ResourceNew {
	...
	public ResourceNew(int resourceId, String resourceName, String resourceType, Timestamp createDate,
			...
			Availability availability, Set<Leaves> leave) {
		super();
	...
	public String toString() {
		return "ResourceNew [resourceId=" + resourceId + ", resourceName=" + resourceName + ", resourceType="
				+ resourceType + ", createDate=" + createDate + ", updateDate=" + updateDate + ", isDeleted="
				+ isDeleted + ", taskList=" + taskList + ", resourceImage=" + resourceImage + ", region=" + region
				+ ", availability=" + availability + ", leave=" + leave + "]";
	}
